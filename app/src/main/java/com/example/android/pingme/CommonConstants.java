...
public final class CommonConstants {
    ...
    public static final String ACTION_DISMISS = "com.example.android.pingme.ACTION_DISMISS"; //    public static final String ACTION_DISMISS = "com.example.android.pingme.ACTION_DISMISS";
